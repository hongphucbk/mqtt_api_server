...
module.exports.postReportDevice = async function(req, res) {
    ...
    // Set value of cell A7.
      ...
      //Header---------------------
        ...
        ws.cell(header_row, 4).string('Thấp điểm (kWh)').style(HeaderStyle)
        ws.cell(header_row, 5).string('Bình thường (kWh)').style(HeaderStyle)
        ws.cell(header_row, 6).string('Cao điểm (kWh)').style(HeaderStyle)
        ws.cell(header_row, 7).string('Tổng (kWh)').style(HeaderStyle)  
